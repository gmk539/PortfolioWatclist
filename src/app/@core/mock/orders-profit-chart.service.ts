...
export class OrdersProfitChartService extends OrdersProfitChartData {
  ...
  getOrdersChartData(period: string, companySymbol : string): Observable<OrdersChart> {
    return observableOf(this.ordersChartService.getOrdersChartData(period,companySymbol));
  }
